...
<div class="main">
	<div class="con_bannerWrap">
		...
		<div class="con_banner clearfix">
			<ul style="background: none repeat scroll 0 0 #FFFFFF; padding: 10px 20px;width: 920px;font-size:14px;line-height:24px;">

<b><?php echo C("site_name");?>网络服务协议</b><br>
<br>
1.	接受条款<br>
<br>
　 　<?php echo C("site_name");?>网，根据以下服务条款为您提供服务。这些条款可由<?php echo C("site_name");?>随时更新，且毋须另行通知。<?php echo C("site_name");?>使用协议（以下简称“使用协议”）一旦发生变动，<?php echo C("site_name");?>将在网页上公布修改内容。修改后的使用协议一旦在网页上公布即有效代替原来的使用协议。此外，当您使用<?php echo C("site_name");?>特殊服务时，您和<?php echo C("site_name");?>应遵守<?php echo C("site_name");?>随时公布的与该服务相关的指引和规则。前述所有的指引和规则，均构成本使用协议的一部分。<br>
<br>
　 　您在使用<?php echo C("site_name");?>提供的各项服务之前，应仔细阅读本使用协议。如您不同意本使用协议及/或随时对其的修改，请您立即停止使用<?php echo C("site_name");?>网所提供的全部服务；您一旦使用<?php echo C("site_name");?>服务，即视为您已了解并完全同意本使用协议各项内容，包括<?php echo C("site_name");?>对使用协议随时所做的任何修改，并成为<?php echo C("site_name");?>用户（以下简称“用户”）。<br>
	<br>
2.	服务说明<br>
<br>
　 　<?php echo C("site_name");?>目前向用户提供如下服务：发布并分享网购经验；收藏网购商品；在<?php echo C("site_name");?>中发布消息、上传图片。除非本使用协议另有其它明示规定，增加或强化目前本服务的任何新功能，包括所推出的新产品，均受到本使用协议之规范。您了解并同意，本服务仅依其当前所呈现的状况提供，对于任何用户信息或个人化设定之时效、删除、传递错误、未予储存或其它任何问题，<?php echo C("site_name");?>均不承担任何责任。<?php echo C("site_name");?>保留不经事先通知为维修保养、升级或其它目的暂停本服务任何部分的权利。<br>
	<br>
3.	遵守法律<br>
<br>
　 　 您同意遵守中华人民共和国相关法律法规的所有规定，并对以任何方式使用您的密码和您的帐号使用本服务的任何行为及其结果承担全部责任。如您的行为违反国家法律和法规的任何规定，有可能构成犯罪的，将被追究刑事责任，并由您承担全部法律责任。<br>
<br>
　 　 同时如果<?php echo C("site_name");?>有理由认为您的任何行为，包括但不限于您的任何言论和其它行为违反或可能违反国家法律和法规的任何规定，<?php echo C("site_name");?>可在任何时候不经任何事先通知终止向您提供服务。<br>
	<br>
4.	您的注册义务<br>
<br>
　 　 为了能使用本服务，您同意以下事项：依本服务注册提示请您填写正确的注册邮箱、密码和名号，并确保今后更新的登录邮箱、名号、头像等资料的有效性和合法性。若您提供任何违法、不道德或<?php echo C("site_name");?>认为不适合在<?php echo C("site_name");?>上展示的资料；或者<?php echo C("site_name");?>有理由怀疑你的资料属于程序或恶意操作，<?php echo C("site_name");?>有权暂停或终止您的帐号，并拒绝您于现在和未来使用本服务之全部或任何部分。<br>
<br>
　 　 <?php echo C("site_name");?>无须对任何用户的任何登记资料承担任何责任，包括但不限于鉴别、核实任何登记资料的真实性、正确性、完整性、适用性及/或是否为最新资料的责任。<br>
	<br>
5.	用户帐号、密码及安全<br>
<br>
　 　 完成本服务的注册程序并成功注册之后，您可使用您的Email和密码，登录到您在<?php echo C("site_name");?>的帐号（下称“帐号”）。保护您的帐号安全，是您的责任。<br>
<br>
　 　 您应对所有使用您的密码及帐号的活动负完全的责任。您同意：<br>
<br>
　 　 1).	您的<?php echo C("site_name");?>帐号遭到未获授权的使用，或者发生其它任何安全问题时，您将立即通知<?php echo C("site_name");?>；<br>
<br>
　 　 2).	如果您未保管好自己的帐号和密码，因此而产生的任何损失或损害，<?php echo C("site_name");?>无法也不承担任何责任；<br>
<br>
　 　 3).	每个用户都要对其帐号中的所有行为和事件负全责。如果您未保管好自己的帐号和密码而对您、<?php echo C("site_name");?>或第三方造成的损害，您将负全部责任。<br>
	<br>
6.	<?php echo C("site_name");?>隐私权政策<br>
<br>
　 　 您提供的登记资料及<?php echo C("site_name");?>保留的有关您的若干其它资料将受到中国有关隐私的法律和本公司《隐私声明》之规范。<br>
	<br>
7.	提供者之责任<br>
<br>
　 　 根据有关法律法规，<?php echo C("site_name");?>在此郑重提请您注意，任何经由本服务而发布、上传的文字、资讯、资料、音乐、照片、图形、视讯、信息或其它资料（以下简称“内容”），无论系公开还是私下传送，均由内容提供者承担责任。<?php echo C("site_name");?>仅为用户提供内容存储空间，无法控制经由本服务传送之内容，因此不保证内容的正确性、完整性或品质。您已预知使用本服务时，可能会接触到令人不快、不适当或令人厌恶之内容。在任何情况下，<?php echo C("site_name");?>均不为任何内容负责，但<?php echo C("site_name");?>有权依法停止传输任何前述内容并采取相应行动，包括但不限于暂停用户使用本服务的全部或部分，保存有关记录，并向有关机关报告。<br>
	<br>
8.	用户行为<br>
<br>
...
　　　* 含有<?php echo C("site_name");?>认为不适合在<?php echo C("site_name");?>展示的内容；<br>
<br>
　 　 2).	以任何方式危害他人的合法权益；<br>
<br>
...
<br>
　 　 您已认可<?php echo C("site_name");?>未对用户的使用行为进行全面控制，您使用任何内容时，包括依赖前述内容之正确性、完整性或实用性时，您同意将自行加以判断并承担所有风险，而不依赖于<?php echo C("site_name");?>。但<?php echo C("site_name");?>依其自行之考虑，拒绝和删除可经由本服务提供之违反本条款的或其它引起<?php echo C("site_name");?>反感的任何内容。<br>
<br>
　 　 您了解并同意，<?php echo C("site_name");?>依据法律法规的要求，或基于诚信为了以下目的或在合理必要范围内，认定必须将内容加以保存或揭露时，得加以保存或揭露：<br>
<br>
　 　 a）遵守法律程序；<br>
　 　 b）执行本使用协议；<br>
　 　 c）回应任何第三人提出的权利主张；<br>
　 　 d）保护<?php echo C("site_name");?>、其用户及公众之权利、财产或个人安全；<br>
　 　 e）其它<?php echo C("site_name");?>认为有必要的情况。<br>
	<br>
9.	国际使用之特别警告<br>
<br>
　 　 您已了解国际互联网的无国界性，同意遵守当地所有关于网上行为及内容之法律法规。您特别同意遵守有关从中国或您所在国家或地区输出信息之传输的所有适用法律法规。<br>
	<br>
10.	在<?php echo C("site_name");?>发布的公开信息<br>
<br>
　 　 1).	在本使用协议中，“本服务公开使用区域”系指一般公众可以使用的区域；<br>
<br>
　 　 2).	用户在<?php echo C("site_name");?>上传或发布的内容，用户应保证其为著作权人或已取得合法授权，并且该内容不会侵犯任何第三方的合法权益，用户同意授予<?php echo C("site_name");?>所有上述内容在全球范围内的免费、不可撤销的、永久的、可再许可或转让的独家使用权许可，据该许可<?php echo C("site_name");?>将有权以展示、推广及其他不为我法律所禁止的方式使用前述内容。<br>
<br>
11.	免责声明<br>
<br>
　 　 1).	用户明确同意其将文字、资讯、资料、音乐、照片、图形、视讯、信息或其它个人资料上传到互联网上，有可能被其他组织或个人复制、转载、或做其它用途的风险完全由其自己承担；因其使用<?php echo C("site_name");?>服务而产生的一切后果也由其自己承担，我们对用户不承担任何责任。<br>
<br>
　 　 2).	微博、人人网等官方帐号对用户的相关文字、资讯、资料、音乐、照片、图形、视讯、信息或其它个人资料进行推广发布的，不属于对用户相关权益的侵权行为、<?php echo C("site_name");?>不承担任何责任。<br>
<br>
　 　 3).	网站上针对用户的恶意评论，经用户的举报我们会采取删除处理，但不保证服务一定能满足用户的要求，也不对该恶意评论负任何法律责任。<br>
	<br>
12.	赔偿<br>
<br>
　 　 由于您通过本服务提供、发布或传送之内容、您与本服务连线、您违反本使用协议、或您侵害他人任何权利因而衍生或导致任何第三人提出任何索赔或请求，包括合理的律师费，您同意赔偿<?php echo C("site_name");?>及其子公司、关联企业、高级职员、代理人、品牌共有人或其它合作伙伴及员工，并使其免受损害，并承担由此引发的全部法律责任。<br>
	<br>
13.	禁止商業行為<br>
<br>
...
14.	关于使用及储存之一般措施<br>
<br>
　 　 您承认关于本服务的使用<?php echo C("site_name");?>有权制订一般措施及限制，包含但不限于本服务将保留所发布内容或其它发布内容之最长期间，以及一定期间内您使用本服务之次数上限（及每次使用时间之上限）。通过本服务发布或传送之任何信息、通讯资料和其它内容，如被删除或未予储存，您同意<?php echo C("site_name");?>毋须承担任何责任。您也同意，<?php echo C("site_name");?>有权依其自行之考虑，不论通知与否，随时变更这些一般措施及限制。<br>
	<br>
15.	服务之修改<br>
<br>
<?php echo C("site_name");?>有权于任何时间暂时或永久修改或终止本服务（或其任何部分），且无论通知与否。您同意对于本服务所作的任何修改、暂停或终止，<?php echo C("site_name");?>对您和任何第三人均无需承担任何责任。<br>
	<br>
16.	终止服务<br>
<br>
　 　 您同意<?php echo C("site_name");?>基于其自行之考虑，因任何理由，包含但不限于缺乏使用，或<?php echo C("site_name");?>认为您已经违反本使用协议的文字及精神，终止您的帐号或本服务之使用（或服务之任何部分），并将您在本服务内任何内容加以移除并删除。您同意依本使用协议任何规定提供之本服务，无需进行事先通知即可中断或终止，您承认并同意，<?php echo C("site_name");?>可立即关闭或删除您的帐号及您帐号中所有相关信息及文件，及/或禁止继续使用前述文件或本服务。此外，您同意若本服务之使用被中断或终止或您的帐号及相关信息和文件被关闭或删除，<?php echo C("site_name");?>对您或任何第三人均不承担任何责任。<br>
	<br>
17.	与广告商及其他第三方进行交易<br>
<br>
　 　 您通过本网站与广告商及其他第三方进行任何形式的通讯或商业往来，或参与促销活动，包含相关商品或服务之付款及交付，以及达成的其它任何相关条款、条件、保证或声明，完全为您与广告商及其他第三方之间之行为。您因前述任何交易或前述广告商及其他第三方而遭受的任何性质的损失或损害，<?php echo C("site_name");?>对此不负任何法律责任。<br>
	<br>
18.	<?php echo C("site_name");?>之专属权利<br>
<br>
　 　 您了解并同意，本服务及本服务所使用之相关软件（以下简称“软件”）含有受到相关知识产权及其它法律保护之专有保密资料。您也了解并同意，经由本服务或广告商向您呈现之赞助广告或信息所包含之内容，亦受到著作权、商标权、服务商标、专利权或其它专属权利之法律保护。未经<?php echo C("site_name");?>或广告商明示授权，您不得修改、出租、出借、出售、散布本服务或软件之任何部份或全部，或据以制作衍生著作，或使用擅自修改后的软件，包括但不限于为了未经授权而使用本服务之目的。<?php echo C("site_name");?>仅授予您个人、不可移转及非专属之使用权，使您得于单机计算机使用其软件之目的码，但您不得（并不得允许任何第三人）复制、修改、创作衍生著作、进行还原工程、反向组译，或以其它方式发现原始码，或出售、转让、再授权或提供软件设定担保，或以其它方式移转软件之任何权利。您同意将通过由<?php echo C("site_name");?>所提供的界面而非任何其它途径使用本服务。<br>
	<br>
19.	担保与保证<br>
<br>
　 　 您明确了解并同意∶<br>
<br>
　 　 1).	本使用协议的任何规定不会免除<?php echo C("site_name");?>对造成您人身伤害的、或因故意或重大过失造成您财产损失的任何责任；<br>
<br>
　 　 2).	您使用本服务之风险由您个人负担。本服务系依“现状”及“现有”基础提供。<?php echo C("site_name");?>对本服务不提供任何明示或默示的担保或保证，包含但不限于商业适售性、特定目的之适用性及未侵害他人权利等担保或保证；<br>
<br>
　 　 3).	<?php echo C("site_name");?>不保证以下事项∶<br>
　　　* 本服务将符合您的要求；<br>
...
<br>
　 　 5).	您自<?php echo C("site_name");?>或经由本服务取得的任何建议或信息，无论是书面或口头形式，除非本使用协议有明确规定，将不构成本使用协议以外之任何保证。<br>
<br>
　 　 6).	如果<?php echo C("site_name");?>和/或合作单位使用您提供的肖像、姓名或其他合法权益，您同意将您的肖像、姓名和/或其他合法权益一并授权给<?php echo C("site_name");?>和/或合作单位使用。<br>
	<br>
20.	责任限制<br>
<br>
　 　 您明确了解并同意，基于以下原因而造成的，包括但不限于利润、信誉、应用、数据损失或其它无形损失，<?php echo C("site_name");?>不承担任何直接、间接、附带、特别、衍生性或惩罚性赔偿责任：<br>
<br>
　 　 1).	本服务之使用或无法使用；<br>
...
　 　 6).	第三方以任何方式发布或投递欺诈性信息，或诱导用户受到经济损失，<?php echo C("site_name");?>不承担任何责任。<br>
	<br>
21.	<?php echo C("site_name");?>商标信息<br>
<br>
　 　 <?php echo C("site_name");?>网、<?php echo C("site_name");?>以及其它<?php echo C("site_name");?>注册商标、标志及产品、服务名称，均为<?php echo C("site_name");?>公司之商标（以下简称“<?php echo C("site_name");?>标记”）。未经<?php echo C("site_name");?>事先书面同意，您同意不将<?php echo C("site_name");?>标记以任何方式展示或使用或作其它处理，或表示您有权展示、使用或另行处理<?php echo C("site_name");?>标记。<br>
	<br>
22.	用户专属权利<br>
<br>
　 　 <?php echo C("site_name");?>尊重他人知识产权，呼吁用户也要同样尊重知识产权。<br>
<br>
　 　 <?php echo C("site_name");?>之服务与资料是基于“现状”提供，而且<?php echo C("site_name");?>明确地表示拒绝对于“服务”、“资料”或“产品”给予任何明示或暗示之保证，包括但不限于，得为商业使用或适合于特定目的之保证。<?php echo C("site_name");?>对于因“服务”、“资料”或“产品”所生之任何直接、间接、附带的或因此而导致之衍生性损失概不负责。<br>
<br>
　 　 如果您对他人的知识产权造成了侵害，<?php echo C("site_name");?>将依国家法律法规的规定，或在适当的情形下，将依其服务条款或其相关规范性规定，删除特定内容或以至终止您对账户的使用。<br>
<br>
　 　 <?php echo C("site_name");?>尊重他人的任何权利（包括知识产权），同时也要求我们的使用者也尊重他人之权利。<?php echo C("site_name");?>在适当情况下，得自行决定终止侵害或违反他人权利之使用者的帐号。<br>
<br>
　 　 若您认为您的作品的著作权遭到侵害或您的知识产权被侵犯，根据《信息网络传播权保护条例》的规定，您需及时向<?php echo C("site_name");?>联系并提供详实的举证材料。或请到中华人民共和国国家版权局下载《要求删除或断开链接侵权网络内容的通知》（下称“删除通知”）的示范格式，如果您不明白“删除通知”的内容，请登录中华人民共和国国家版权局查看《要求删除或断开链接侵权网络内容的通知》填写说明。<br>
	<br>
23.	一般条款<br>
<br>
　 　 1).	本使用协议、社区指导原则和免责声明构成您与<?php echo C("site_name");?>之全部协议，并规范您对于本服务之使用行为。在您使用相关服务、使用第三方提供的内容或软件时，亦应遵从所适用之附加条款及条件；<br>
<br>
　 　 2).	本使用协议及您与<?php echo C("site_name");?>之关系，均受到中华人民共和国法律管辖。您与<?php echo C("site_name");?>就本服务、本使用协议或其它有关事项发生的争议，应首先友好协商解决，协商不成时应提请中国国际经济贸易仲裁委员会仲裁，仲裁裁决是终局性的，对双方均有约束力；<br>
<br>
　 　 3).	<?php echo C("site_name");?>未行使或执行本使用协议任何权利或规定，不构成对前述权利或权利之放弃；<br>
<br>
　 　 4).	倘本使用协议之任何规定因与中华人民共和国法律抵触而无效，您依然同意应依照法律，努力使该规定所反映之当事人意向具备效力，且本使用协议其它规定仍应具有完整的效力及效果；<br>
<br>
　 　 5).	本使用协议之标题仅供方便而设，不具任何法律或契约效果；<br>
	<br>
　 　 6).	只要您登录了<?php echo C("site_name");?>，就代表您认可以上所有协议。<br>
<br>
　 　 7).	<?php echo C("site_name");?>对本使用协议享有最终解释权。<br>
