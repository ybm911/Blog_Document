...
<div class="main">
	...
	<div id="search_name" style="display:none;"><?php echo ($keywords); ?></div>
	...
	<div class="cate_tit">
         <ul>
		 	<li class="sort">
                <span>排序：</span> 
				<p>
					<a class="l <?php if($sortby == 'time'): ?>curr<?php endif; ?>" href="<?php echo get_url('index',$keywords,'search','time');?>" rel="nofollow">最新</a>
					<a class="r <?php if($sortby == 'likes'): ?>curr<?php endif; ?>" href="<?php echo get_url('index',$keywords,'search','likes');?>" rel="nofollow">最热</a>
				</p>
            </li>
		</ul>
	</div>
...
<?php if(is_array($items_list)): $i = 0; $__LIST__ = $items_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voItems): $mod = ($i % 2 );++$i;?><div class="col co">
  ...
  <div class="page"><?php echo ($page); ?></div><?php endif; ?>
	...
	<div id='url' style="display:none;"><?php echo C('web_path');?>index.php?a=search&m=Public&g=Home&keywords=<?php echo (htmlspecialchars($_GET['keywords'])); ?>&sortby=<?php echo ($_REQUEST['sortby']); ?></div>
</div>
