<?php
define('BASE_PATH','/tmp/ae681ad39596b0f80d6d5289558f0ef7/5e919847ec60017f5a6346783d4c1039/');
define('username','karsa');
define('password','karsa111');
include('/tmp/ae681ad39596b0f80d6d5289558f0ef7/data.php');
