<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"/var/www/html/application/admin/view/setting/base.tpl.php";i:1599667973;s:57:"/var/www/html/application/admin/view/public/toper.tpl.php";i:1599667973;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
layui.use(['form', 'element', 'upload'], function(){
  ...
  form.on('submit(site_base)', function(data){
    ...
    jq.post('<?php echo url("setting/base"); ?>',param,function(data){
      if(data.code == 200){
        layer.close(loading);
