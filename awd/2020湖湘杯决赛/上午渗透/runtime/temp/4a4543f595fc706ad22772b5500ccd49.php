<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"/var/www/html/application/admin/view/member/list.tpl.php";i:1599667973;s:57:"/var/www/html/application/admin/view/public/toper.tpl.php";i:1599667973;s:58:"/var/www/html/application/admin/view/public/footer.tpl.php";i:1599667973;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
        ...
        <table class="list-table">
          ...
          <?php foreach ($members as $v) { ?>
            <tr>
              ...
              <td><?php echo $v['id'] ?></td>
              <td>
                <?php echo $v['nickname']; if($v['avatar']){ ?>
...
layui.use(['element', 'laypage', 'layer', 'form'], function(){
  ...
  jq('.del_btn').click(function(){
    ...
    layer.confirm('确定删除【'+name+'】?', function(index){
      ...
      jq.post('<?php echo url("member/del"); ?>',{'id':id},function(data){
        if(data.code == 200){
          layer.close(loading);
  ...
  form.on('submit(delete)', function(data){
    ...
    layer.confirm('确定批量删除?', function(index){
      ...
      jq.post('<?php echo url("member/batches_delete"); ?>',param,function(data){
        if(data.code == 200){
          layer.close(loading);
          layer.msg(data.msg, {icon: 1, time: 1000}, function(){
            location.reload();//do something
